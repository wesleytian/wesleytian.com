	...
	return (
		<Grid item container justify="flex-start" direction="column">
			...
			<Typography
				...
				paragraph>
				<b>
					Keep up to date with my blog posts by subscribing to my newsletter{" "}
					<a href="https://buttondown.email/wesleytian" target="_blank">
						here
					</a>
					. I promise to send you newsletters at most once every two weeks. Up
					Next: "Why I Turned Down Big Tech Out Of College."
				</b>
			</Typography>
			<Typography
				variant="body1"
