          ...
          paddingBottom: "8rem",
				...
				<div>
					...
					<div>
						<div>
							<p>
								🌎 I'm currently living in San Francisco, but I grew up in San
								Jose, CA; metro Portland, Oregon; Taipei, Taiwan; and Shanghai,
								China.
							</p>
							<div>
								<p>
									🧑🏻‍💻 I spend most of my time helping build a platform for
									purchasing fractional ownership of homes at an{" "}
									<a
										className=""
							...
							<p>
								I was also a software engineer at Microsoft and studied computer
					...
					<div>
						...
						<ul>
							<li>
								May, 2022 <a href="/posts/sf">I fucking love SF</a>
							</li>

							<li>
								November, 2021{" "}
								<a href="/posts/ironman">
									I did a 140.6-mile Ironman race (draft)
								</a>
							</li>

							<li>
								July, 2020{" "}
								<a href="/posts/reno">Why did I move to to Reno, Nevada?</a>
							</li>

							<li>
								August, 2019{" "}
								<a href="/posts/whitney">
									I convinced 3 friends to climb the tallest mountain in the
									contiguous US with me and we had to drink piss to survive
								</a>
							</li>

							<li>
								June 2019 <a href="/posts/gpa">I nearly failed high school</a>{" "}
					...
					<div>
						<p>
							...
							<a href="https://twitter.com/wesleyytian"> here</a> (I'll follow
							you back), connect with me on LinkedIn{" "}
							<a href="https://linkedin.com/in/wesleytian">here</a>, and email
							me <a href="mailto:tian.wesley@gmail.com">here</a>.
						</p>
					</div>
				</div>
			</main>
